<jsp:include page="cabecalho.jsp" />
      ...
      <div class="row roxo_claro">
        <h2 id="cabecalho">RPG (Reeduca&ccedil;&atilde;o Postural Global)</h2>
      </div>
          ...
          <div id="myCarousel" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <img src="img/rpg.jpg" class="img-rounded">
                <!-- <div class="carousel-caption">
                  <p>RPG</p>
                </div> -->
              </div>
              <div class="item">
                <img src="img/rpg2.jpg" class="img-rounded">
                <!-- <div class="carousel-caption">
                  <p>RPG</p>
                </div> -->
              </div>
              <div class="item">
                <img src="img/rpg3.jpg" class="img-rounded">
                <!-- <div class="carousel-caption">
                  <p>RPG</p>
                </div> -->
              </div>
              <div class="item">
                <img src="img/rpg4.jpg" class="img-rounded">
                <!-- <div class="carousel-caption">
                  <p>RPG</p>
                </div> -->
              </div>
